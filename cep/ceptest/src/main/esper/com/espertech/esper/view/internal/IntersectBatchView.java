 ...
 */
public class IntersectBatchView extends ViewSupport implements LastPostObserver, CloneableView, StoppableView {
	 ...
	 */
	public IntersectBatchView(AgentInstanceViewFactoryChainContext agentInstanceViewFactoryContext, IntersectViewFactory factory, EventType eventType,
			List<View> viewList, List<ViewFactory> viewFactories, boolean hasAsymetric) {
