...
public final class AddPropertyValueView extends ViewSupport implements CloneableView, StoppableView {
	 ...
	 */
	public AddPropertyValueView(AgentInstanceViewFactoryChainContext agentInstanceContext, String[] propertyNames, Object mergeValues,
	...
	public final void update(EventBean[] newData, EventBean[] oldData) {
		...
		if (newData != null) {
			...
			for (EventBean newEvent : newData) {
				EventBean theEvent = addProperty(newEvent, propertyNames, propertyValues, eventType, agentInstanceContext.getStatementContext()
		...
		if (oldData != null) {
			...
			for (EventBean oldEvent : oldData) {
				...
				if (outgoing != null) {
					...
					EventBean theEvent = addProperty(oldEvent, propertyNames, propertyValues, eventType, agentInstanceContext.getStatementContext()
							.getEventAdapterService());
	...
	public final Iterator<EventBean> iterator() {
		...
		return new Iterator<EventBean>() {
			...
			public EventBean next() {
				...
				if (mustAddProperty) {
					return addProperty(nextEvent, propertyNames, propertyValues, eventType, agentInstanceContext.getStatementContext().getEventAdapterService());
				} else {
					return nextEvent;
				}
			}
	 ...
	 */
	protected static EventBean addProperty(EventBean originalEvent, String[] propertyNames, Object propertyValues, EventType targetEventType,
	...
	public final String toString() {
		return this.getClass().getName() + " propertyNames=" + Arrays.toString(propertyNames) + " propertyValue=" + propertyValues;
	}
