...
public class ContextPropertiesTest {
	public static void main(String[] args) {
		...
		// 创建context
		String epl1 = "create context esbtest partition by id from " + esb + ", age from " + Person.class.getName();
		...
		String epl3 = "context esbtest select context.id,context.name,context.key1 from " + Person.class.getName();
