...
public class GroupbyTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		state.addListenerWithReplay(new GroupbyListener());
	...
	public void testLastPrice() {
		Assert.assertEquals(30, GroupbyListener.last[0]);
		System.out.println("type: eos, lastPrice: 30");
		Assert.assertEquals(40, GroupbyListener.last[1]);
		System.out.println("type: bps, lastPrice: 40");
		Assert.assertEquals(25, GroupbyListener.last[2]);
		System.out.println("type: esb, lastPrice: 25");
	}

	@Test
	public void testPriceList() {
		Assert.assertEquals("[30]", GroupbyListener.list[0]);
		System.out.println("type: eos, priceList: [30]");
		Assert.assertEquals("[40]", GroupbyListener.list[1]);
		System.out.println("type: bps, priceList: [40]");
		Assert.assertEquals("[20, 35, 25]", GroupbyListener.list[2]);
		System.out.println("type: esb, priceList: [20, 35, 25]");
	}
